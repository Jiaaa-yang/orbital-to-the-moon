...
class TestTweet(unittest.TestCase):
    ...
    def test_get_link_works_with_valid_id(self):
        test_tweet = Tweet(id='1234', date='200-01-01', symbol='MSFT', text='test string', likes=0)
    ...
    def test_get_link_raises_value_error_with_empty_id(self):
        test_tweet = Tweet(id='', date='200-01-01', symbol='MSFT', text='test string', likes=0)
    ...
    def test_get_truncated_text_truncates_long_text(self):
        ...
        test_tweet = Tweet(id='', date='200-01-01', symbol='MSFT', text=long_text, likes=0)
    ...
    def test_get_truncated_text_leaves_short_text_unchanged(self):
        ...
        test_tweet = Tweet(id='', date='2000-01-01', symbol='MSFT', text=short_text, likes=0)
        actual_text = test_tweet.get_truncated_text()
        self.assertEqual(actual_text, short_text)


    def test_get_truncated_text_works_with_non_default_arguments(self):
        test_tweet = Tweet(id='1234', date='200-01-01', symbol='MSFT', text='text with 4 words', likes=0)
